...
int_perc = c(0.35, 0.375, 0.40, 0.425)
conf_vect = seq(-2, 2, 0.5)
grid = expand.grid(int_perc, conf_vect)
if(scenario == "bias_full_overlap_conf"){
  overlap_deg = 1
}
if(scenario == "bias_50_conf"){
  overlap_deg = 0.50
  
}
if(scenario == "bias_no_overlap_conf"){
  overlap_deg = 0
...
saveRDS(all_trials, paste0(savewd, "/both_version/", "overlap_", overlap_deg, "_n", int_val, "_conf_", conf, "_opt", ".RDS"))
